...
import { CreditCard, Phone, ArrowRight } from "lucide-react";

/** Checkout disabled — this is a medicine availability site, not a shop. */
export const Checkout: React.FC = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
    ...
    <h1 className="text-2xl font-bold text-foreground">Online Checkout Coming Soon</h1>
    <p className="mt-2 text-muted-foreground max-w-sm">
      Online payment and checkout will be available soon. Visit our store or call us to place your order.
    </p>
